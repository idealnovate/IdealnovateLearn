/**
 * AI Income Blueprint by Idealnovate
 ...
 * 5. Copy the Web App URL and paste it into aiblueprint/index.html
...
// ── CONFIG ───────────────────────────────────────────────────────────────────
const SHEET_NAME   = 'AI Blueprint Enrollments2'; // Tab name in your Google Sheet
...
const COHORT_DATE  = 'September 13th 2026';
...
function sendWelcomeEmail(data) {
  ...
  const subject = `Welcome to AI Income Blueprint, ${firstName}!`;
...
<div class="wrapper">
  ...
  <div class="header">
    <h1>You&#8217;re In! &#10003;</h1>
    <p>AI Income Blueprint by Idealnovate</p>
  </div>
